...
class ShiftSignupNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject("Neue Anmeldung: {$this->shift->role}")
            ->greeting('Hallo!')
            ->line("{$this->volunteer->name} hat sich für eine Schicht angemeldet:")
