        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="remember" class="rounded border-gray-300 text-[#4a90a4] focus:ring-[#4a90a4]">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Noch kein Konto?
                    <a href="{{ route('register') }}" class="text-[#4a90a4] hover:text-[#2c5aa0]">
                        Jetzt registrieren
                    </a>
                </p>
            </div>
