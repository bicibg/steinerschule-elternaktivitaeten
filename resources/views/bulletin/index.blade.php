...
@section('content')
    ...
    @if($totalCount === 0)
        <x-card>
            <div class="text-center py-8 px-4">
                ...
                <h2 class="text-lg font-semibold text-gray-600 mb-2">Keine Pinnwand-Einträge</h2>
                <p class="text-gray-500 text-sm">
                    Momentan keine Helfergesuche vorhanden.
                </p>
                <a href="{{ route('activities.index') }}" class="mt-3 inline-flex items-center text-sm text-steiner-blue hover:text-steiner-dark">
                    Zu den Elternaktivitäten
    ...
    @elseif($bulletinPosts->isEmpty())
        <x-card>
            <div class="text-center py-8">
                <p class="text-gray-500">
                    Keine Einträge in der Kategorie "{{ $categories[$selectedCategory] ?? $selectedCategory }}" gefunden.
                </p>
