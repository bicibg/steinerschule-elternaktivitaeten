    ...
    @if($totalCount === 0)
        <x-card>
            <div class="text-center py-12">
                ...
                <h2 class="text-lg font-semibold text-gray-600 mb-2">Zurzeit keine Pinnwand-Einträge</h2>
                <p class="text-gray-500 max-w-md mx-auto">
                    Es sind momentan keine Helfergesuche auf der Pinnwand. Sobald eine Aktivität Unterstützung braucht, erscheint der Aufruf hier.
                </p>
